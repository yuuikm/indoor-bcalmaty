export interface VertexDataThird {
  id: string;
...
export interface EdgeDataThird {
  id: string;
  from: string;
  to: string;
}
export interface GraphDataThird {
  vertices: VertexDataThird[];
  edges: EdgeDataThird[];
}
export const graphDataThird: GraphDataThird = {
  vertices: [
    ...
    { id: "v9", objectName: "Арендатор 324", cx: 157.3, cy: 763.5 },
    ...
    { id: "v17", objectName: "ТОО «ПрофБухУчет»", cx: 190.5, cy: 386.4 },
    ...
    { id: "v28", objectName: "ТОО «Киловольт групп»", cx: 252.3, cy: 439.1 },
    ...
    { id: "v44", objectName: "Арендатор 311", cx: 1314.4, cy: 366.9 },
    { id: "v45", objectName: null, cx: 529.3, cy: 705.7 },
    { id: "v46", objectName: "ТОО «Fin-Xaus»", cx: 529.3, cy: 691.3 },
    ...
    { id: "v50", objectName: "ИП «RUFINA»", cx: 636, cy: 691.3 },
    { id: "v53", objectName: null, cx: 723.8, cy: 705.7 },
    { id: "v54", objectName: "ИП «AQNIET trans group»", cx: 723.8, cy: 691.3 },
    { id: "v55", objectName: null, cx: 800.4, cy: 705.7 },
    { id: "v56", objectName: "ИП «ALL Solutions»", cx: 800.4, cy: 691.3 },
    ...
    { id: "v65", objectName: "ТОО «Q PROJECTS»", cx: 1020, cy: 773 },
    ...
    { id: "v69", objectName: "ТОО «ЭкоФармИнтернейшнл»", cx: 1209.7, cy: 720.6, },
    ...
    { id: "v74", objectName: "ТОО «Exploration service»", cx: 1344.3, cy: 720.6, },
    { id: "v75", objectName: "ТОО Business Pulse", cx: 430.4, cy: 573.7 },
    { id: "v76", objectName: "ТОО «EVS GROUP»", cx: 547.3, cy: 549.1 },
    { id: "v77", objectName: null, cx: 205.4, cy: 578.2 },
    { id: "v78", objectName: "ТОО «НҰР АСТАНА ҚҰРЫЛЫС»", cx: 191.3, cy: 578.2 },
  ],
