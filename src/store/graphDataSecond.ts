export interface VertexDataSecond {
  id: string;
...
export interface EdgeDataSecond {
  id: string;
  from: string;
  to: string;
}
export interface GraphDataSecond {
  vertices: VertexDataSecond[];
  edges: EdgeDataSecond[];
}
export const graphDataSecond: GraphDataSecond = {
  vertices: [
    ...
    { id: "v4", objectName: "ТОО «Компания международных транспортных услуг Чэньсин Кахан»", cx: 191.3, cy: 550.7, },
    { id: "v5", objectName: null, cx: 205.4, cy: 662.1 },
    { id: "v6", objectName: null, cx: 205.4, cy: 780.6 },
    { id: "v7", objectName: "Арендатор 223", cx: 205.4, cy: 796 },
    { id: "v8", objectName: null, cx: 157.3, cy: 780.6 },
    { id: "v9", objectName: "ИП «Дэя»", cx: 157.3, cy: 763.5 },
    ...
    { id: "v17", objectName: "1.ТОО «SCC GROUP» 2.ТОО «Sky Capital Construction»", cx: 160.3, cy: 370.5, },
    ...
    { id: "v28", objectName: "Арендатор 203", cx: 252.3, cy: 439.1 },
    { id: "v29", objectName: null, cx: 547.3, cy: 529.5 },
    { id: "v30", objectName: "Арендатор 206", cx: 547.3, cy: 510.4 },
    { id: "v31", objectName: null, cx: 834.6, cy: 529.5 },
    { id: "v32", objectName: "Арендатор 206", cx: 834.6, cy: 510.4 },
    ...
    { id: "v39", objectName: "ТОО «LIGHTHouse Kazakhstan»", cx: 1043.3, cy: 364.3, },
    ...
    { id: "v44", objectName: "ТОО «АДИЛИ ТЕКСТИЛЬ»", cx: 1314.4, cy: 366.9 },
    { id: "v45", objectName: null, cx: 529.3, cy: 705.7 },
    { id: "v46", objectName: "ТОО«ЕвроТрейдингЦентр»", cx: 529.3, cy: 691.3 },
    { id: "v47", objectName: null, cx: 564.9, cy: 705.7 },
    { id: "v48", objectName: "ТОО «CART Company»", cx: 564.9, cy: 719.6 },
    { id: "v49", objectName: null, cx: 636, cy: 705.7 },
    { id: "v50", objectName: "ТОО «Типл ААА»", cx: 636, cy: 691.3 },
    { id: "v51", objectName: null, cx: 694.6, cy: 705.7 },
    { id: "v52", objectName: "Арендатор 218", cx: 694.6, cy: 719.6 },
    { id: "v53", objectName: null, cx: 723.8, cy: 705.7 },
    { id: "v54", objectName: "ТОО «ABC Compressor»", cx: 723.8, cy: 691.3 },
    { id: "v55", objectName: null, cx: 800.4, cy: 705.7 },
    { id: "v56", objectName: "ТОО ОП LEGION", cx: 800.4, cy: 691.3 },
    { id: "v57", objectName: null, cx: 825.3, cy: 705.7 },
    { id: "v58", objectName: "ТОО «Проект инвест групп»", cx: 825.3, cy: 719.6, },
    ...
    { id: "v65", objectName: "ТОО «Современная защита»", cx: 1020, cy: 773 },
    { id: "v66", objectName: null, cx: 1154.6, cy: 735.6 },
    { id: "v67", objectName: "ИП «ТЮННИГ ТЕЛА»", cx: 1154.6, cy: 720.6 },
    { id: "v68", objectName: null, cx: 1209.7, cy: 735.6 },
    { id: "v69", objectName: "ТОО «Адили текстиль»", cx: 1209.7, cy: 720.6 },
    ...
    { id: "v74", objectName: "ТОО «BestProfi»", cx: 1344.3, cy: 720.6 },
  ],
