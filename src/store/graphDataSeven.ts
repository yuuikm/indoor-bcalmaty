export interface VertexDataSeven {
  id: string;
...
export interface EdgeDataSeven {
  id: string;
  from: string;
  to: string;
}
export interface GraphDataSeven {
  vertices: VertexDataSeven[];
  edges: EdgeDataSeven[];
}
export const graphDataSeven: GraphDataSeven = {
  vertices: [
    ...
    { id: "v20", objectName: "Арендатор 705", cx: 866.3, cy: 693.4 },
    { id: "v21", objectName: null, cx: 855.7, cy: 531.5 },
    { id: "v22", objectName: "Арендатор 706", cx: 855.8, cy: 517.7 },
