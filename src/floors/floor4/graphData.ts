...
export const graphData: GraphData = {
  vertices: [
    ...
    { id: "v9", objectName: "MK.PIMC.KZ ТОО, КазУютдомстрой, ТОО АнбинКазИнвест, ПСК CITY ENGINEERING ТОО", cx: 157.3, cy: 763.5 },
    { id: "v10", objectName: null, cx: 401.4, cy: 662.1 },
    { id: "v11", objectName: null, cx: 417.2, cy: 662.1 },
    { id: "v12", objectName: "СМАРТКАМ", cx: 429.7, cy: 662.1 },
    ...
    { id: "v17", objectName: "ТОО “Duoturk”, ТОО “TPRESS”", cx: 190.5, cy: 386.4 },
    ...
    { id: "v25", objectName: "INTERBEST", cx: 374.9, cy: 462.6 },
    { id: "v26", objectName: null, cx: 401.4, cy: 426.5 },
    { id: "v27", objectName: null, cx: 252.3, cy: 426.5 },
    { id: "v28", objectName: "Alem GROUP", cx: 252.3, cy: 439.1 },
    ...
    { id: "v44", objectName: "ГККП «ШВСМ» Управления Спорта г.Алматы", cx: 1314.4, cy: 366.9 },
    { id: "v45", objectName: null, cx: 529.3, cy: 705.7 },
    { id: "v46", objectName: "REINA Group ТОО", cx: 529.3, cy: 691.3 },
    { id: "v47", objectName: null, cx: 564.9, cy: 705.7 },
    { id: "v48", objectName: "Salyk Consulting", cx: 564.9, cy: 719.6 },
    { id: "v49", objectName: null, cx: 636, cy: 705.7 },
    { id: "v50", objectName: "Рекламное агентство", cx: 636, cy: 691.3 },
    { id: "v53", objectName: null, cx: 723.8, cy: 705.7 },
    { id: "v54", objectName: "Amidina kids", cx: 723.8, cy: 691.3 },
    { id: "v55", objectName: null, cx: 800.4, cy: 705.7 },
    { id: "v56", objectName: "AUKER", cx: 800.4, cy: 691.3 },
    ...
    { id: "v65", objectName: "ИСТКОНСАЛТ", cx: 1020, cy: 773 },
    { id: "v66", objectName: null, cx: 1154.6, cy: 735.6 },
    { id: "v67", objectName: "ГККП «ШВСМ» Управления Спорта г.Алматы", cx: 1154.6, cy: 720.6 },
    { id: "v68", objectName: null, cx: 1209.7, cy: 735.6 },
    { id: "v69", objectName: "ADN GROUP", cx: 1209.7, cy: 720.6 },
    { id: "v70", objectName: null, cx: 1291.5, cy: 735.6 },
    { id: "v71", objectName: "Hericium-Rex, ТОО «Сертификация и безопасность» Обучение и выдача сертификатов для юридических лиц, WLS KZ", cx: 1291.5, cy: 749.6 },
    ...
    { id: "v75", objectName: "Eyeline", cx: 430.4, cy: 573.7 },
    { id: "v76", objectName: "ИНВЕСТ СТРОЙ ГРУПП", cx: 547.3, cy: 549.1 },
    { id: "v77", objectName: null, cx: 205.4, cy: 578.2 },
    { id: "v78", objectName: "Bolashaq Arman", cx: 191.3, cy: 578.2 },
  ],
